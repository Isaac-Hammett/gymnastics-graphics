...
(function() {
  ...
  const layoutOverrideMapping = {
    ...
    // Now-competing specific (Phase 7E.3)
    ncBottom: { suffix: 'nc-bottom', unit: 'px' },
    ncLeft: { suffix: 'nc-left', unit: 'px' },
    ncStatusBg: { suffix: 'nc-status-bg', unit: null },
    ncStatusPaddingV: { suffix: 'nc-status-padding-v', unit: 'px' },
    ncStatusPaddingH: { suffix: 'nc-status-padding-h', unit: 'px' },
    ncStatusGap: { suffix: 'nc-status-gap', unit: 'px' },
    ncDotSize: { suffix: 'nc-dot-size', unit: 'px' },
    ncDotColor: { suffix: 'nc-dot-color', unit: null },
    ncStatusFontSize: { suffix: 'nc-status-font-size', unit: 'px' },
    ncStatusFontWeight: { suffix: 'nc-status-font-weight', unit: null },
    ncStatusColor: { suffix: 'nc-status-color', unit: null },
    ncLogoContainerWidth: { suffix: 'nc-logo-container-width', unit: 'px' },
    ncLogoContainerBg: { suffix: 'nc-logo-container-bg', unit: null },
    ncLogoContainerPadding: { suffix: 'nc-logo-container-padding', unit: 'px' },
    ncLogoSize: { suffix: 'nc-logo-size', unit: 'px' },
    ncEventBg: { suffix: 'nc-event-bg', unit: null },
    ncEventPaddingV: { suffix: 'nc-event-padding-v', unit: 'px' },
    ncEventPaddingH: { suffix: 'nc-event-padding-h', unit: 'px' },
    ncEventMinWidth: { suffix: 'nc-event-min-width', unit: 'px' },
    ncEventFontSize: { suffix: 'nc-event-font-size', unit: 'px' },
    ncEventFontWeight: { suffix: 'nc-event-font-weight', unit: null },
    ncEventColor: { suffix: 'nc-event-color', unit: null },
    ncDetailsBg: { suffix: 'nc-details-bg', unit: null },
    ncDetailsPaddingV: { suffix: 'nc-details-padding-v', unit: 'px' },
    ncDetailsPaddingH: { suffix: 'nc-details-padding-h', unit: 'px' },
    ncNameFontSize: { suffix: 'nc-name-font-size', unit: 'px' },
    ncNameFontWeight: { suffix: 'nc-name-font-weight', unit: null },
    ncNameColor: { suffix: 'nc-name-color', unit: null },
    ncTeamFontSize: { suffix: 'nc-team-font-size', unit: 'px' },
    ncTeamFontWeight: { suffix: 'nc-team-font-weight', unit: null },
    ncTeamColor: { suffix: 'nc-team-color', unit: null },
    // Live-camera specific (Phase 7E.3)
    lcTop: { suffix: 'lc-top', unit: 'px' },
    lcLeft: { suffix: 'lc-left', unit: 'px' },
    lcGap: { suffix: 'lc-gap', unit: 'px' },
    lcIndicatorBg: { suffix: 'lc-indicator-bg', unit: null },
    lcIndicatorColor: { suffix: 'lc-indicator-color', unit: null },
    lcIndicatorPaddingV: { suffix: 'lc-indicator-padding-v', unit: 'px' },
    lcIndicatorPaddingH: { suffix: 'lc-indicator-padding-h', unit: 'px' },
    lcIndicatorRadius: { suffix: 'lc-indicator-radius', unit: 'px' },
    lcIndicatorFontSize: { suffix: 'lc-indicator-font-size', unit: 'px' },
    lcIndicatorFontWeight: { suffix: 'lc-indicator-font-weight', unit: null },
    lcDotSize: { suffix: 'lc-dot-size', unit: 'px' },
    lcDotColor: { suffix: 'lc-dot-color', unit: null },
    lcIndicatorGap: { suffix: 'lc-indicator-gap', unit: 'px' },
    lcApparatusPaddingV: { suffix: 'lc-apparatus-padding-v', unit: 'px' },
    lcApparatusPaddingH: { suffix: 'lc-apparatus-padding-h', unit: 'px' },
