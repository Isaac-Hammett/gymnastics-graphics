Step 1: Read IMPLEMENTATION-PLAN.md                    (~240 lines)
Step 2: Read PRD-OBS-02-SceneManagement.md             (~200 lines)
...
commit and push: git add -A && git commit -m "PRD-OBS-02: ..." && git push origin main
