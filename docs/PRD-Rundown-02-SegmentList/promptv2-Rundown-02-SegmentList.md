# PRD-Rundown-02 Implementation Workflow
...
- [ ] **1.1** Read PRD: `docs/PRD-Rundown-02-SegmentList/PRD-Rundown-02-SegmentList.md`
...
- [ ] **1.2** Read Implementation Plan: `docs/PRD-Rundown-02-SegmentList/PLAN-Rundown-02-SegmentList-Implementation.md`
...
- [ ] **4.1** Stage and commit:
  ```bash
  git add -A && git commit -m "PRD-Rundown-02: [brief description]" && git push origin main
  ```
