# Renderer System Phase 5: Graphics Reorganization — Code Loop

> Reference: `docs/_template/standard-loop-v2/LOOP-SYSTEM.md`

## Context — Read These First
- Specs: `docs/PRD-Renderer-System/phase-5/specs/*.md` (requirements — one file per topic)
...
## Back Pressure
```bash
# Registry generation — must pass first
...
## Local Verification
```
# URL Generator (start dev server if needed: cd show-controller && npm run dev)
http://localhost:5173/url-generator

# Select a competition and verify sidebar structure
```
...
- [ ] `docs/PRD-Renderer-System/phase-5/fixes.md` — if a fix line exists, it is your **priority task** (skip to step 3)
- [ ] `docs/PRD-Renderer-System/phase-5/plan.md` — find next task to work on. Read Learnings + Bugs.
...
- [ ] Screenshot → `docs/PRD-Renderer-System/phase-5/screenshots/local-task-{id}.png`
...
- [ ] Something wrong → one fix attempt:
  ...
  5. Re-screenshot → `docs/PRD-Renderer-System/phase-5/screenshots/local-task-{id}-fix.png`
...
```bash
git add stage/ show-controller/src/ docs/PRD-Renderer-System/phase-5/ docs/PRD-Renderer-System/phase-1/agent.md docs/PRD-Renderer-System/PRD-Renderer-System-2026-03-28.md
