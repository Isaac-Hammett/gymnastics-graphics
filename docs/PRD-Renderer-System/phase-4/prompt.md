# Renderer System Phase 4: Tool Integration — Code Loop

> Reference: `docs/_template/standard-loop-v2/LOOP-SYSTEM.md`

## Context — Read These First
- Specs: `docs/PRD-Renderer-System/phase-4/specs/*.md` (requirements — one file per topic)
...
## Back Pressure
```bash
# Build script (manifest validation)
node scripts/buildGraphicsRegistry.js

# React build (includes prebuild hook)
...
# URL Generator
http://localhost:5173/url-generator

# Web Graphics Panel (inside producer view)
http://localhost:5173/producer/{compId}
```
...
- [ ] `docs/PRD-Renderer-System/phase-4/fixes.md` — if a fix line exists, it is your **priority task** (skip to step 3)
- [ ] `docs/PRD-Renderer-System/phase-4/plan.md` — find next task to work on. Read Learnings + Bugs.
...
- [ ] Screenshot → `docs/PRD-Renderer-System/phase-4/screenshots/local-task-{id}.png`
...
- [ ] Something wrong → one fix attempt:
  ...
  5. Re-screenshot → `docs/PRD-Renderer-System/phase-4/screenshots/local-task-{id}-fix.png`
...
```bash
git add scripts/ stage/ show-controller/src/ docs/PRD-Renderer-System/phase-4/ docs/PRD-Renderer-System/phase-1/agent.md docs/PRD-Renderer-System/PRD-Renderer-System-2026-03-28.md docs/PRD-Renderer-System/Phase-4-Tool-Integration.md
