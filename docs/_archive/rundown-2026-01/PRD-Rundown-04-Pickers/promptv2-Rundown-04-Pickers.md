# PRD-Rundown-04 Implementation Workflow
...
- [ ] **1.1** Read PRD: `docs/PRD-Rundown-04-Pickers/PRD-Rundown-04-Pickers.md`
...
- [ ] **1.2** Read Implementation Plan: `docs/PRD-Rundown-04-Pickers/PLAN-Rundown-04-Pickers-Implementation.md`
...
- [ ] **4.1** Stage and commit:
  ```bash
  git add -A && git commit -m "PRD-Rundown-04: [brief description]" && git push origin main
  ```
