# PRD-Rundown-07 Implementation Workflow
...
- [ ] **1.1** Read PRD: `docs/PRD-Rundown-07-FrontendIntegration/PRD-Rundown-07-FrontendIntegration.md`
...
- [ ] **1.2** Read Implementation Plan: `docs/PRD-Rundown-07-FrontendIntegration/PLAN-Rundown-07-FrontendIntegration-Implementation.md`
...
- [ ] **4.1** Stage and commit:
  ```bash
  git add -A && git commit -m "PRD-Rundown-07: [brief description]" && git push origin main
  ```
