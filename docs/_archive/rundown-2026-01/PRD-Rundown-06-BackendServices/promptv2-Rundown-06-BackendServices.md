# PRD-Rundown-06 Implementation Workflow
...
- [ ] **1.1** Read PRD: `docs/PRD-Rundown-06-BackendServices/PRD-Rundown-06-BackendServices.md`
...
- [ ] **1.2** Read Implementation Plan: `docs/PRD-Rundown-06-BackendServices/PLAN-Rundown-06-BackendServices-Implementation.md`
...
- [ ] **4.1** Stage and commit:
  ```bash
  git add -A && git commit -m "PRD-Rundown-06: [brief description]" && git push origin main
  ```
