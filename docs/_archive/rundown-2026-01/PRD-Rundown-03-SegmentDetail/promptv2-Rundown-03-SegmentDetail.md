# PRD-Rundown-03 Implementation Workflow
...
- [ ] **1.1** Read PRD: `docs/PRD-Rundown-03-SegmentDetail/PRD-Rundown-03-SegmentDetail.md`
...
- [ ] **1.2** Read Implementation Plan: `docs/PRD-Rundown-03-SegmentDetail/PLAN-Rundown-03-SegmentDetail-Implementation.md`
...
- [ ] **4.1** Stage and commit:
  ```bash
  git add -A && git commit -m "PRD-Rundown-03: [brief description]" && git push origin main
  ```
