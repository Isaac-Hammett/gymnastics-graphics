# PRD-Rundown-08 Implementation Workflow
...
- [ ] **1.1** Read PRD: `docs/PRD-Rundown-08-ProducerIntegration/PRD-Rundown-08-ProducerIntegration.md`
...
- [ ] **1.2** Read Implementation Plan: `docs/PRD-Rundown-08-ProducerIntegration/PLAN-Rundown-08-ProducerIntegration-Implementation.md`
...
- [ ] **4.1** Stage and commit:
  ```bash
  git add -A && git commit -m "PRD-Rundown-08: [brief description]" && git push origin main
  ```
