Step 1: Read IMPLEMENTATION-PLAN.md                    (~60 lines)
Step 2: Read PRD-OBS-07-AssetManagement.md             (~250 lines)
...
commit and push: git add -A && git commit -m "PRD-OBS-07: ..." && git push origin main
