...
2. Add dual persistent video elements (clipVideo, clipVideoNext) with CSS class swap mechanism for transitions — NOT STARTED
3. Add clip-playback renderer with athlete info overlay and score reveal at Math.max(duration-5, duration*0.6) — NOT STARTED
4. Add moment-replay renderer with REPLAY badge, seek range, playback rate, muted default — NOT STARTED
