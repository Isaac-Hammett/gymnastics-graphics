...
2. Create CameraStatusPanel.jsx — camera grid with state dots, Force Camera buttons, apparatus labels, recording timers — NOT STARTED
...
7. Create useKeyboardShortcuts.js hook and KeyboardShortcutsPanel.jsx — shortcut listener with focus scope, modal exception, remapping UI, localStorage persistence — NOT STARTED
