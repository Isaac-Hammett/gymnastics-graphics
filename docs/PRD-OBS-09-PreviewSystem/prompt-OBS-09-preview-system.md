Step 1: Read IMPLEMENTATION-PLAN.md                    (~100 lines)
Step 2: Read PRD-OBS-09-PreviewSystem.md               (~997 lines)
...
commit and push: git add -A && git commit -m "PRD-OBS-09: ..." && git push origin main
