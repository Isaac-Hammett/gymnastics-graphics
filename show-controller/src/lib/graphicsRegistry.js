...
export const GRAPHICS = {
  ...
  'team-stats': {
    ...
    category: 'pre-meet',
    keywords: ['stats', 'statistics', 'average', 'high', 'score', 'team', 'nqs'],
    gender: 'both',
    renderer: 'overlay',
    ...
    params: {
      ...
      statType: {
        type: 'enum',
        options: ['avg', 'nqs', 'high'],
        optionLabels: { 'avg': 'Season Average (AVG)', 'nqs': 'NQS', 'high': 'Season High (HIGH)' },
        default: 'avg',
        label: 'Stat Type',
      },
      statLabel: { type: 'string', label: 'Stat Label', default: 'AVG' },
      statValue: { type: 'string', label: 'Stat Value' },
  ...
  'who-to-watch': {
    ...
    category: 'pre-meet',
    keywords: ['who to watch', 'highlight', 'featured', 'spotlight', 'standout', 'athlete', 'star'],
    gender: 'both',
    renderer: 'overlay',
    ...
    params: {
      ...
      subtitle: { type: 'string', label: 'Subtitle (year, hometown, apparatus)' },
      statLabel: { type: 'string', label: 'Stat Label', default: 'Season High' },
      statValue: { type: 'string', label: 'Stat Value' },
    },
  },
  ...
  'who-to-watch-title': {
    ...
    category: 'pre-meet',
    keywords: ['who to watch', 'title card', 'spotlight', 'featured', 'athlete', 'full screen', 'espn'],
    gender: 'both',
    renderer: 'overlay',
    ...
    params: {
      ...
      body: { type: 'string', label: 'Body text' },
      imageUrl: { type: 'string', label: 'Athlete Image URL' },
      imageMode: { type: 'string', default: 'portrait', label: 'Image Mode' },
      badge: { type: 'string', default: 'WHO TO WATCH', label: 'Badge Text' },
      nameFontSize: { type: 'number', min: 40, max: 100, default: 64, label: 'Name Font Size' },
      bodyFontSize: { type: 'number', min: 18, max: 44, default: 30, label: 'Body Font Size' },
      headlineFontSize: { type: 'number', min: 16, max: 40, default: 28, label: 'Headline Font Size' },
      textOffsetY: { type: 'number', min: -200, max: 200, default: 0, label: 'Text Y Offset' },
      imageScale: { type: 'number', min: 50, max: 150, default: 100, label: 'Image Scale %' },
      imageOffsetX: { type: 'number', min: -200, max: 200, default: 0, label: 'Image X Offset' },
      imageOffsetY: { type: 'number', min: -200, max: 200, default: 0, label: 'Image Y Offset' },
    },
  },
  ...
  'stream-starting': {
    ...
    params: {
      ...
      logo: { type: 'string', source: 'competition' },
      logo2: { type: 'string', source: 'competition', optional: true },
      logo3: { type: 'string', source: 'competition', optional: true },
      logo4: { type: 'string', source: 'competition', optional: true },
      logo5: { type: 'string', source: 'competition', optional: true },
      logo6: { type: 'string', source: 'competition', optional: true },
      logo7: { type: 'string', source: 'competition', optional: true },
      eventName: { type: 'string', source: 'competition' },
