/**
 * Quick script to add Zachary Silao's headshot to Firebase
 * Run with: node scripts/add-zachary-silao.js
 */
...
async function addZacharySilao() {
  const name = 'Zachary Silao';
  const headshotUrl = 'https://media.virti.us/upload/images/athlete/hORrKA3wv48UQXjIr5kX1';
  const teamKey = 'navy-mens';
