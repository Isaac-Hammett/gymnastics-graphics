# AGENT.md - {{PROJECT_NAME}} Knowledge
...
Task(subagent_type="Explore", prompt="Search codebase for relevant components")
Task(subagent_type="general-purpose", prompt="Take screenshot of target page")
Task(subagent_type="general-purpose", prompt="Check API health")
